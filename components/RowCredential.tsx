import { AvailableCredential, CredentialFormats } from '../pages/api/credentials';
    ...
    <>
      <div className="flex flex-row gap-5 justify-between">
        <div className="flex flex-row gap-5 items-center">
          ...
          <button onClick={() => { setModalVisible(true) }} className="h-4 text-gray-500 hover:text-primary-400 cursor-pointer">
            Set Modal Visible
          </button>
        </div>
